 ...
 */
function _civicrm_api3_civiquickfile_contactpush_spec(&$spec) {
 ...
 */
function civicrm_api3_civiquickfile_contactpush($params) {
  $quickfile = new CRM_Civiquickfile_Contact();
  $quickfile->push($params);
}
